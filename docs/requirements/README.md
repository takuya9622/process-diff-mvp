...
| [../design/demo-state.md](../design/demo-state.md) | 公開デモの共有状態、競合、リセット | 更新処理、公開時の注意、リセットを実装するとき |
...
画面一覧とユーザーフロー、ドメインモデル、システム構成と技術選定に加え、サンプル業務、
影響候補の探索仕様、公開デモの状態管理まで初期方針を決定済みです。次は、実装へ向けて
次の順で具体化します。

1. 各画面状態のワイヤーフレームと表示項目
2. 実装計画と受け入れテスト
